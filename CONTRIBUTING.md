Contributing to ABET Core
============================

The ABET Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the abet unit tests or QA tests
...
[Translation Process](https://github.com/abet-project/abet/blob/master/doc/translation_process.md)
...
The following applies to code changes to the ABET Core project, and is not to be
confused with overall ABET Network Protocol consensus changes.

Whether a pull request is merged into ABET Core rests with the project merge
...
Patches that change ABET consensus rules are considerably more involved than
...
Where a patchset proposes to change the ABET consensus, it must have been
...
The project leader is the release manager for each ABET Core release.
