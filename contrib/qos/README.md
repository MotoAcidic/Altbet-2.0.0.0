...
This means one can have an always-on altbetd instance running, and another local altbetd/abet-qt instance which connects to this node and receives blocks from it.
