...
1. Clone the ABET Core source code:

        git clone https://github.com/abet-project/abet
        cd abet
...
Before running, you may create an empty configuration file:
    ...
    mkdir -p "/Users/${USER}/Library/Application Support/ABET"

    touch "/Users/${USER}/Library/Application Support/ABET/abet.conf"
...
You can monitor the download process by looking at the debug.log file:
    ...
    tail -f $HOME/Library/Application\ Support/ABET/debug.log
