UNIX BUILD NOTES
====================
Some notes on how to build ABET Core in Unix.

Note
---------------------
Always use absolute paths to configure and compile ABET Core and the dependencies,
...
memory available when compiling ABET Core. On systems with less, gcc can be
...
above instead of `libssl-dev`. ABET Core does not support the use of OpenSSL 1.1, though compilation is still possible
...
To build ABET Core without wallet, see [*Disable-wallet mode*](/doc/build-unix.md#disable-wallet-mode)
...
Security
--------
To help make your ABET Core installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, ABET Core should be built with a non-executable stack
...
When the intention is to run only a P2P node without a wallet, ABET Core may be compiled in
