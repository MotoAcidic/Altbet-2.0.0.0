ABET Core version 2.3.1 is now available from:
...
If you are running an older version, shut it down. Wait until it has completely shut down (which might take a few minutes for older versions), then run the installer (on Windows) or just copy over /Applications/ABET-Qt (on Mac) or abetd/altbet-qt (on Linux).
...
Examples:
> altbet-cli startmasternode "alias" true "my_mn"
...
Examples:
> altbet-cli mnbudgetvote "local" "ed2f83cedee59a91406f5f47ec4d60bf5a7f9ee6293913c82976bd2d3a658041" "yes"
...
[
  {
    ...
    "PaymentAddress": "xxxx",     (string) ABET address of payment
