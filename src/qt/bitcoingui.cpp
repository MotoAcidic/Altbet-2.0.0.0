...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Altbet"), this);
    aboutAction->setStatusTip(tr("Show information about Altbet"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Altbet help message to get a list with possible ABET command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Altbet client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Altbet"); // default title
